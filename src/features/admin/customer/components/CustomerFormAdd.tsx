// @features/customer/components/CustomerFormAdd.tsx
...
import { useCustomerCreation } from "../hooks/useCustomer";
import { CustomerCreateDTO } from "@core/model/customer";

const InitialValue: CustomerCreateDTO = {
  name: "",
  address: "",
  phone: "",
  email: "",
...
export const CustomerFormAdd: React.FC = () => {
  const mutation = useCustomerCreation();

  const [customerBody, setCustomerBody] = useState<CustomerCreateDTO>({
    ...InitialValue,
  });
  const [errors, setErrors] = useState<
    Partial<Record<keyof CustomerCreateDTO, string>>
  >({});

  const navigate = useNavigate();

  const validate = () => {
    const newErrors: Partial<Record<keyof CustomerCreateDTO, string>> = {};
    let isValid = true;
