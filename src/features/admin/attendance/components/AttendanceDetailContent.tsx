...
import LocationMap from "@features/_global/components/LocationMap";
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col">
                    ...
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <span
                        className={`badge bg-${status.class}-subtle text-${status.class} px-3 py-2 rounded-pill d-flex align-items-center`}
                      >
                        {status.icon}
          ...
          <div className="col-lg-6 mb-4">
            <div className="card shadow-sm border-0 h-100">
              <div className="card-header bg-success text-white border-0 d-flex align-items-center">
                ...
                <h5 className="mb-0 text-white">Check In</h5>
              </div>
                ...
                {attendance.checkin_time ? (
                      ...
                      <div className="col-12">
                        <div className="mb-3">
                          <div className="d-flex align-items-center mb-2">
                            <div className="bg-primary-subtle p-2 rounded me-2">
                              <FaMapMarkerAlt
                                className="text-primary"
                                style={{ fontSize: "1rem" }}
                              />
                            </div>
                            <h6 className="mb-0">Lokasi Check In</h6>
                          </div>
                          <LocationMap
                          ...
                          <small className="text-muted mt-2 d-block">
                            Koordinat: {attendance.checkin_latitude?.toFixed(6)}
                            , {attendance.checkin_longitude?.toFixed(6)}
                          </small>
                        </div>
                      </div>
                  ...
                  <div className="text-center py-5">
                    ...
                    <p className="text-muted">
                      Karyawan belum melakukan check in pada tanggal ini
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="col-lg-6 mb-4">
            <div className="card shadow-sm border-0 h-100">
              <div className="card-header bg-danger text-white border-0 d-flex align-items-center">
                ...
                <h5 className="mb-0 text-white">Check Out</h5>
              </div>
              <div className="card-body mt-4">
                {attendance.checkout_time ? (
                  <div className="space-y-4">
                      ...
                      <div className="col-12">
                        <div className="mb-3">
                          <div className="d-flex align-items-center mb-2">
                            ...
                            <h6 className="mb-0">Lokasi Check Out</h6>
                          </div>
                          <LocationMap
                            latitude={attendance.checkout_latitude}
                            longitude={attendance.checkout_longitude}
                            title="Lokasi Check Out"
                            officeLat={-6.1876709} // Your office coordinates
                            officeLng={106.6646784}
                            allowedRadius={300}
                          />
                          <small className="text-muted mt-2 d-block">
                            Koordinat:{" "}
                            {attendance.checkout_latitude?.toFixed(6)},{" "}
                            {attendance.checkout_longitude?.toFixed(6)}
                          </small>
                        </div>
                      </div>
                  ...
                  <div className="col-md-6">
                    <div className="d-flex align-items-center p-3 bg-light rounded">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          {attendance.employee?.email || "Tidak tersedia"}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="d-flex align-items-center p-3 bg-light rounded">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          {attendance.employee?.address || "Tidak tersedia"}
                        </p>
                      </div>
                    </div>
                  </div>
